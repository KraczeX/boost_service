          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">Stawowa 7, 63-600 Hanulin</span>
              </li>
              <li className="flex items-start gap-3">
                <svg className={`w-5 h-5 ${colors.text} flex-shrink-0 mt-0.5`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                </svg>
                <a href="tel:+48725490466" className={`text-gray-400 hover:${colors.text} transition-colors text-sm`}>
                  +48 725 490 466
                </a>
              </li>
              <li className="flex items-start gap-3">
                ...
                <span className="text-gray-400 text-sm">pliki.boost-service@wp.pl</span>
              </li>
            </ul>
          </div>
