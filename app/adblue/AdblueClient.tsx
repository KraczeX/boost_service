...
interface AdblueClientProps {
  realizacje: Realizacja[];
}

export default function AdblueClient({ realizacje }: AdblueClientProps) {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
      {adblueRealizacje.length > 0 ? (
        adblueRealizacje.map((realizacja, index) => (
