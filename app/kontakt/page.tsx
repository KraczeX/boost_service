            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16">
              ...
              <AnimatedSection direction="right" delay={100} className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-6">
                  <div className="flex items-start gap-4">
                    <div className={`flex-shrink-0 w-12 h-12 ${colors.bgLight} border ${colors.borderLight} rounded-lg flex items-center justify-center`}>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="tel:+48XXXXXXXXX" className={`${colors.text} hover:${colors.textStats} transition-colors text-sm sm:text-base`}>
                        +48 XXX XXX XXX
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <a href="mailto:kontakt@boost-service.pl" className={`${colors.text} hover:${colors.textStats} transition-colors text-sm sm:text-base`}>
              ...
              <AnimatedSection direction="left" delay={200}>
                <div className={`bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl overflow-hidden`}>
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 p-6 sm:p-8 pb-0">
                    Lokalizacja <span className={colors.gradientText}>Warsztatu</span>
                  </h2>
                  <div className="relative w-full h-[400px] sm:h-[500px] md:h-[600px]">
                    <iframe
                      src="https://www.google.com/maps?q=Hanulin+23,+Kępno,+Poland&output=embed"
                      width="100%"
                      height="100%"
                      style={{ border: 0 }}
                      allowFullScreen
                      ...
                      title="Lokalizacja warsztatu - Hanulin 0, Kępno"
                    ></iframe>
                  </div>
                  <div className="p-6 sm:p-8 pt-4">
                    <a
                      href="https://www.google.com/maps/search/?api=1&query=Hanulin+0,+Kępno"
                      target="_blank"
