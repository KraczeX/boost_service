...
import UsaConversionClient from './UsaConversionClient';
import type { Realizacja } from '@/utils/realizacje';

interface UsaConversionContentProps {
  realizacje: Realizacja[];
}

export default function UsaConversionContent({ realizacje }: UsaConversionContentProps) {
  const { themeColor } = useTheme();
  const colors = getThemeColors(themeColor);
  
  const usaConversionRealizacje = realizacje.filter(r => r.category === 'Konwersja USA');
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
              <AnimatedSection direction="right" delay={100} className="relative order-2 lg:order-1">
                <div className="relative h-[300px] sm:h-[400px] md:h-[500px] rounded-2xl overflow-hidden border-2 border-white/10">
                  <ImageWithFallback
                    src="/realizacje/bmw/592370304_1533717815428255_7148405695979271444_n.jpg"
                    alt="USA conversion"
                    className="w-full h-full object-cover"
                    loading="lazy"
                    fill
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 mb-12 sm:mb-16">
              <AnimatedSection direction="right" delay={100}>
                <div className="relative h-[300px] sm:h-[400px] rounded-2xl overflow-hidden border-2 border-white/10">
                  <ImageWithFallback
                    src="/realizacje/bmw/591831982_1533717782094925_609722780348058647_n.jpg"
                    alt="USA conversion services"
                    className="w-full h-full object-cover"
                    loading="lazy"
                    fill
              ...
              <AnimatedSection direction="left" delay={200}>
                <div className="relative h-[300px] sm:h-[400px] rounded-2xl overflow-hidden border-2 border-white/10">
                  <ImageWithFallback
                    src="/realizacje/bmw/591887093_1533717845428252_2178732791081934857_n.jpg"
                    alt="USA conversion services"
                    className="w-full h-full object-cover"
                    loading="lazy"
                    fill
        ...
        <section className="py-12 sm:py-16 md:py-24 bg-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <AnimatedSection direction="fade" className="text-center mb-8 sm:mb-12 md:mb-16">
              ...
              <p className="text-base sm:text-lg md:text-xl text-gray-400 max-w-2xl mx-auto px-4">
                Zobacz przykłady naszych projektów konwersji USA
              </p>
            </AnimatedSection>

            <UsaConversionClient realizacje={usaConversionRealizacje} />
          </div>
        </section>
      </main>
  );
