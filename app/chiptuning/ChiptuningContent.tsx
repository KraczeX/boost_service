...
import ChiptuningClient from './ChiptuningClient';
import type { Realizacja } from '@/utils/realizacje';

interface ChiptuningContentProps {
  realizacje: Realizacja[];
}

export default function ChiptuningContent({ realizacje }: ChiptuningContentProps) {
    ...
    <main>
        ...
        <section className="py-12 sm:py-16 md:py-24 bg-black">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <ChiptuningClient realizacje={chiptuningRealizacje} />
          </div>
        </section>
      </main>
  );
